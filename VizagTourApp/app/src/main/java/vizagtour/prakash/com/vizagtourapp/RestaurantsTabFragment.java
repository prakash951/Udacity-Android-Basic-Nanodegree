...
public class RestaurantsTabFragment extends Fragment {
     ...
     * @return A new instance of fragment RestaurantsTabFragment.
     */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View myTabView = inflater.inflate(R.layout.fragment_restaurants_tab, null, false);
        final TabLayout myTabLayout = myTabView.findViewById(R.id.tab1);
        final ViewPager myViewPager = myTabView.findViewById(R.id.pager1);
        myViewPager.setAdapter(new RestaurantTabAdapter(getChildFragmentManager()));
